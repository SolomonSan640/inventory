...
class SubCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        if (strtolower('en') === "mm") {
            $subcategories = SubCategory::with('categoryMm', 'subCategoryImage')->select($columns)->orderBy('updated_at', 'desc')->get();
        } else {
            $subcategories = SubCategory::with('categoryEn', 'subCategoryImage')->select($columns)->orderBy('updated_at', 'desc')->get();
        }
